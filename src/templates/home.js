export function createHome() {
    ...
    `<div id="home" style="background-color: #dddddd; padding: 0px; margin: 0px; width: 100%; height: 100%;">
        ...
        <div class="main row row-cols-auto" style="display: flex;align-content: baseline;     margin-left: 140px;">
            <div id="CategoryArtists" class="category col-6" >
                <img style="width:80%;" src="../../../img/240.jpg" alt="">
                <div style="width: 80%; background-color: #b6b6b6;">Artists Quiz</div>
            </div>
            <div id="CategoryPictures" class="category col-6" >
                <img style="width:80%;" src="../../../img/1.jpg" alt="">
                <div style="width: 80%; background-color: #b6b6b6;">Pictures Quiz</div>
            </div>
        </div>
        <div class="setting" id="btn-logo-settings" style="display: block;">
